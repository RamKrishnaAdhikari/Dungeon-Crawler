...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridWidget->setCursor(QCursor(Qt::BlankCursor));
        ...
        turn->setCursor(QCursor(Qt::ArrowCursor));
        ...
        up->setCursor(QCursor(Qt::ArrowCursor));
        ...
        down->setCursor(QCursor(Qt::ArrowCursor));
        ...
        downleft->setCursor(QCursor(Qt::ArrowCursor));
        ...
        right->setCursor(QCursor(Qt::ArrowCursor));
        ...
        upright->setCursor(QCursor(Qt::ArrowCursor));
        ...
        upleft->setCursor(QCursor(Qt::ArrowCursor));
        ...
        downright->setCursor(QCursor(Qt::ArrowCursor));
        ...
        left->setCursor(QCursor(Qt::ArrowCursor));
